...
class zar6 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_zar6)
        ...
        val ivDice5: ImageView = findViewById(R.id.ivDice5)
        val ivDice6: ImageView = findViewById(R.id.ivDice6)
        ...
        btnRoll.setOnClickListener {
            ...
            val result5 = rollDice()
            val result6 = rollDice()
            ...
            val drawableResource5 = getDrawableResource(result5)
            val drawableResource6 = getDrawableResource(result6)
            ...
            ivDice5.setImageResource(drawableResource5)
            ivDice6.setImageResource(drawableResource6)

            val total = result1+result2+result3+result4+result5+result6
